  ...
  render() {
    ...
    return (
      <Container className="Main">
        ...
        <h2>
          Hubsters:{" "}
          {asset.hubsters.map(hubster => hubster.hubster_name).join(", ")}
        </h2>
        <br />
        <h2>
          Industries:{" "}
          {asset.industries.map(industry => industry.text).join(", ")}
        </h2>
        <br />
        <h2>
          Cloud Services:{" "}
          {asset.cloudServices
            .map(cloudService => cloudService.text)
            .join(", ")}
        </h2>
        <br />
        <h2>Pillars: {asset.pillars.map(pillar => pillar.text).join(", ")}</h2>
        <br />
        <br />
        <h2>Notional Architecture:</h2>
        <br />
