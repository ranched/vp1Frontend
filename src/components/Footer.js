    ...
    <Segment vertical className='App-footer'>
        <Container textAlign='center'>
            <Grid divided stackable>
                ...
                <Grid.Column width={8} >
                    <Header as='h4' content='Release version 1.0' className="footer-text" />
                    <p><a href="mailto:portal_feedback@cloudsolutionhubs.com?subject=Asset%20Portal%20Feedback&body=Please%20tell%20us%20about%20your%20experience%20using%20the%20portal:">
